...
async def help_button(client, callback_query):
    help_text = (
        "╭━━━━━━━✦✧✦━━━━━━━╮\n"
        "💥 🂾 ᴍʀ DHRUV ʙᴏᴛꜱ ᴄᴏᴍᴍᴀɴᴅꜱ\n"
        "╰━━━━━━━✦✧✦━━━━━━━╯\n"
        "📌 ᴍᴀɪɴ ꜰᴇᴀᴛᴜʀᴇꜱ:\n"
        "➥ /start – ʙᴏᴛ ꜱᴛᴀᴛᴜꜱ ᴄʜᴇᴄᴋ\n"
        "➥ /drm – ᴇxᴛʀᴀᴄᴛ ꜰʀᴏᴍ .txt (ᴀᴜᴛᴏ)\n"
        "➥ /y2t – ʏᴏᴜᴛᴜʙᴇ → .txt ᴄᴏɴᴠᴇʀᴛᴇʀ\n"
        "➥ /t2t – ᴛᴇxᴛ → .txt ɢᴇɴᴇʀᴀᴛᴏʀ\n"
        "➥ /stop – ᴄᴀɴᴄᴇʟ ʀᴜɴɴɪɴɢ ᴛᴀꜱᴋ\n"
        "⚙️ ᴛᴏᴏʟꜱ & ꜱᴇᴛᴛɪɴɢꜱ:\n"
        "➥ /cookies – ᴜᴘᴅᴀᴛᴇ ʏᴛ ᴄᴏᴏᴋɪᴇꜱ\n"
        "➥ /getcookies – ɢᴇᴛ ᴄᴜʀʀᴇɴᴛ ᴄᴏᴏᴋɪᴇꜱ\n"
        "➥ /id – ɢᴇᴛ ᴄʜᴀᴛ/ᴜꜱᴇʀ ɪᴅ\n"
        "➥ /info – ᴡᴇʟᴄᴏᴍᴇ ᴅᴇᴛᴀɪʟꜱ\n"
        "➥ /logs – ᴠɪᴇᴡ ʙᴏᴛ ᴀᴄᴛɪᴠɪᴛʏ\n"
        "💬 ᴄʜᴀᴛ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ:\n"
        "➥ /add_chat <chat_id> – ᴀᴅᴅ ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀᴛ\n"
        "➥ /remove_chat <chat_id> – ʀᴇᴍᴏᴠᴇ ᴄʜᴀᴛ\n"
        "➥ /list_chats – ʟɪꜱᴛ ʏᴏᴜʀ ᴄʜᴀᴛꜱ\n"
        "👑 ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ:\n"
        "➥ /adduser <user_id> <days> – ᴀᴅᴅ ᴜꜱᴇʀ\n"
        "➥ /removeuser <user_id> – ʀᴇᴍᴏᴠᴇ ᴜꜱᴇʀ\n"
        "➥ /checkuser <user_id> – ᴄʜᴇᴄᴋ ᴜꜱᴇʀ\n"
        "➥ /users – ʟɪꜱᴛ ᴀʟʟ ᴜꜱᴇʀꜱ\n"
        "➥ /diagnose <user_id> – ᴅɪᴀɢɴᴏꜱᴇ ᴜꜱᴇʀ\n"
        "➥ /dbstatus – ᴄʜᴇᴄᴋ ᴅᴀᴛᴀ ꜱᴛᴀᴛᴜꜱ\n"
        "💡 Note: Only authorized users can run admin commands.\n"
        "Made by: Mʀ DHRUV 🂾"
    )
